...
This week, you'll use a Rails app to generate web pages on a local server.

*In order for the tests to pass, be sure to have your app running on port 3000 in a separate Terminal tab while you run the tests.*
...
* Going to the home page should display the same content as the page-specific url. Redirects are not allowed.
